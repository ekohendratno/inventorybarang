...
<head>
    ...
    <script defer src="<?php echo base_url(); ?>assets/js/fontawesome/js/all.js"></script>
    	
	<link rel="icon" type="image/ico" href="<?php echo base_url('assets/img/logo.ico') ?>">
    ...
    <link rel="stylesheet" href="<?php echo base_url('assets/js/datatables/css/dataTables.bootstrap.css'); ?>"/>
	<link href="<?php echo base_url('assets/css/jquery-ui-timepicker-addon.min.css') ?>" rel="stylesheet">
    <style type="text/css">
        /*body{
            background: #ddd url("<?php echo base_url('assets/img/bg3.png') ?>") right center repeat;
		}*/
